...
-- Output: ACME (Kyoto), ACME (Duluth), Allied, Basics, Tiptop
--         Weyland-Yutani and their total ordered quantity.
-- Note: Wasn't too sure to show ACME as one or to show them by their
--	 respective cities, so I did the latter.
